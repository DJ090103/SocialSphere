...
export const login = async (req, res) => {
    try {
        ...
        const user = await User.findOne({ email })
            ...
            .populate({
                path: "followings",
                select: "username profilePicture _id",  // include specific fields needed for chat
            });
...
export const getSuggestedUsers = async (req, res) => {
    try {
        ...
        const requester = await User.findById(requesterId).select("followings");
        const excludedIds = [requesterId, ...(requester?.followings || [])];
